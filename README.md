...
Final score is clipped to **[0.1, 0.9]**.
...
// Response
{
  ...
  "reward": 0.9,
  "done": true,
  "info": { "task_id": "single_service_down", "step": 1, "action": "restart_service:api_gateway", "reward": 0.9 }
}
```
...
// Response
{ "task_id": "single_service_down", "score": 0.9, "history": [...] }
```
...
| Task | Score |
|------|-------|
| `single_service_down` | 0.90 |
| `memory_leak_cascade` | 0.90 |
| `ghost_deploy_regression` | 0.90 |
| **Mean** | **0.90** |
